...
const EditProductDetails = ({handleCancel}: propTypes) => {
        ...
        <form className="mt-5">
          ...
          <div className="mb-3">
            ...
            <div className='d-flex align-items-center p-0'>
              <input className="form-control form-control-lg shadow-none"  id="images" type="file" />
              <button className='btn btnPurple px-4 m-0 ms-3'>Add</button>
            </div>
          </div>
