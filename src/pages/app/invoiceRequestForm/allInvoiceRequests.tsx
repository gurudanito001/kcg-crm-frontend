...
interface InvoiceRequestListItemProps {
  handleClick?: ()=>void
}
const InvoiceRequestListItem = ({handleClick}: InvoiceRequestListItemProps) =>{
  const navigate = useNavigate()
  return(
    <li className='d-flex border-bottom py-3 listItem' onClick={()=>navigate("/app/invoiceRequest/r355645")}>
